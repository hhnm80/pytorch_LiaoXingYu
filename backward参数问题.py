...
# 于是c对a求导,得到的肯定是一个二维,首先是c[0,0]对a求导,是c[0,0]对a[0,0]和a[0,1]求导的和,,,,然后是c[0,1]对a[0,0]和a[0,1]求导的和,,,这么理解是错的吧.......c对a求导,是以a为主体,那么是这样的么,是c[0,0]对a[0,0]和a[0,1]分别求导的和,然后是c[0,1]对a[0,0]和a[0,1]分别求导的和,这么看结果是[
